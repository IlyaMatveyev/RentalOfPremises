...
namespace RentalOfPremises.API.Controllers
{
    ...
    public class AdvertsController : ControllerBase
    {
        ...
        /*
         ...
         3) Посмотреть все свои объявления                          + (но надо будет ещё вытягивать коллекцию фото)
        3+) Посмотреть все опубликованные объявления                + (но надо будет ещё вытягивать коллекцию фото)
